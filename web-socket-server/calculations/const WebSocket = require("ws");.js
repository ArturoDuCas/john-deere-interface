...
wss.on("connection", (connection, req) => {
    ...
    connection.on("message", (data) => {
        ...
        if (message.type === "field_matrix") {
            ...
            const pythonProcess = spawn("python", ["your_script.py", JSON.stringify(message.data)]);
...
// Assuming fieldMatrixData is your JSON data
const jsonString = JSON.stringify(fieldMatrixData);

// Then, send it to the Python script as an argument
const { spawn } = require('child_process');
const pythonProcess = spawn('python', ['your_script.py', jsonString]);

// Rest of your code to handle the Python script's output
